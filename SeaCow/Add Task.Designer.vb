...
Partial Class Add_Task
    ...
    Private Sub InitializeComponent()
        ...
        Me.TaskNameTxtBox.TabIndex = 70
        Me.TaskNameTxtBox.WatermarkText = "Enter the name of the task."
        '
        'TaskDescTxtBox
        '
        '
        ...
        Me.TaskDescTxtBox.TabIndex = 67
        Me.TaskDescTxtBox.WatermarkText = "Enter the description of the task."
        '
        'StatusBox
        '
